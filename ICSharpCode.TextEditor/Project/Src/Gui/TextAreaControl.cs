	...
	public class TextAreaControl : Panel
	{
		...
		public void ResizeTextArea()
		{
			...
			textArea.Bounds = new Rectangle(0, y,
			                                Width - SystemInformation.HorizontalScrollBarArrowWidth,
			                                Height - (hScrollBar.Visible ? SystemInformation.VerticalScrollBarArrowHeight : 0) - h);
			SetScrollBarBounds();
		}
		
		public void SetScrollBarBounds()
		{
			vScrollBar.Bounds = new Rectangle(textArea.Bounds.Right, 
                                              0,
		...
		public void AdjustScrollBars()
		{
			...
			hScrollBar.Maximum = (Math.Max(max, textArea.TextView.VisibleColumnCount - 1));
            bool oldVisible = hScrollBar.Visible;
            hScrollBar.Visible = (hScrollBar.Maximum >= textArea.TextView.VisibleColumnCount);
            ...
            if (oldVisible != hScrollBar.Visible) ResizeTextArea();
		}
